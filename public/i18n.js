...
(function () {
  ...
  Object.assign(es, {
  "RIGRX / ROADSIDE SERVICES": "RIGRX / SERVICIOS EN CARRETERA",
  "ROADSIDE / REPAIR / RECOVERY": "ASISTENCIA / REPARACIÓN / RESCATE",
  "Built for the road.": "Hecho para la carretera.",
  "Ready for the unexpected.": "Listo para lo inesperado.",
  "Your rig. Your road. Your next move. Connect with the service companies that keep you moving.": "Su camión. Su ruta. Su próximo paso. Conéctese con las compañías que le ayudan a seguir adelante.",
  "Repair": "Reparación",
  "Recovery": "Rescate",
  "WELCOME TO RIGRX": "BIENVENIDO A RIGRX",
  "Get back on the road.": "Vuelva a la carretera.",
  "Enter your mobile number and we’ll text you a code to sign in.": "Ingrese su celular y le enviaremos un código para iniciar sesión.",
  "Run a service company? Meet RIGRX.": "¿Tiene una compañía de servicio? Conozca RIGRX.",
  "Your next move starts here.": "Su próximo paso empieza aquí.",
  "Tell us what happened. Compare providers. Choose your help.": "Cuéntenos qué pasó. Compare proveedores. Elija su ayuda.",
  "Your equipment": "Su equipo",
  "Manage": "Administrar",
  "Save your truck details for your next request.": "Guarde los datos de su camión para su próxima solicitud.",
  "Recent requests": "Solicitudes recientes",
  "A fresh start.": "Un nuevo comienzo.",
  "Your completed and cancelled requests will appear here.": "Sus solicitudes completadas y canceladas aparecerán aquí.",
  "Your equipment. Ready for every request.": "Su equipo. Listo para cada solicitud.",
  "Add truck": "Agregar camión",
  "Add trailer": "Agregar remolque",
  "Make your next request easier.": "Facilite su próxima solicitud.",
  "Add your trucks and trailers once. Their details travel with your requests.": "Agregue sus camiones y remolques una vez. Sus datos acompañan cada solicitud.",
  "Your service conversations, all in one place.": "Todas sus conversaciones de servicio en un solo lugar.",
  "Search conversations": "Buscar conversaciones",
  "Company, service or request number": "Compañía, servicio o número de solicitud",
  "Messages with service providers will appear here when you connect.": "Los mensajes con proveedores aparecerán aquí cuando se conecten.",
  ...
  "Technician": "Técnico",
  "MESSAGES / SERVICE": "MENSAJES / SERVICIO",
  "Your conversation": "Su conversación",
  "Keep the details, quote and next steps together.": "Mantenga juntos los detalles, la cotización y los próximos pasos.",
  "All messages": "Todos los mensajes",
  "Confirm the scope, price and estimated arrival with your provider before choosing.": "Confirme el alcance, el precio y la llegada estimada con su proveedor antes de elegir.",
  ...
  "Your tools, team and account.": "Sus herramientas, equipo y cuenta.",
  "Open conversation": "Abrir conversación",
  "Scrollable table": "Tabla desplazable",
  "Compare your responses": "Compare sus respuestas",
  "Waiting for providers": "Esperando proveedores",
  "Provider selected": "Proveedor elegido",
  "Compare up to four responses. You choose your provider.": "Compare hasta cuatro respuestas. Usted elige al proveedor.",
  "Service quote": "Cotización de servicio",
  "Estimated arrival": "Llegada estimada",
  "Send message": "Enviar mensaje",
  "Message": "Mensaje",
  "My company": "Mi compañía",
  "Length": "Longitud",
  "Axles": "Ejes",
  "Suspension": "Suspensión",
  "Your exact location is shared with the provider you choose.": "Su ubicación exacta se comparte con el proveedor que elija."
});
